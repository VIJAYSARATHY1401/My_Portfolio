            ...
            <div className="col-md-4">
              <div className="card">
                ...
                <div className="card-body">
                  <h5 className="card-title">Tic Tac Toe Gaming Application</h5>
                  <span className="badge bg-primary">
                    Front-end Development
                  </span>
                  <p className="card-text">
                    A portale and stylish Tic-Tac-Toe Game Built using React JS
                  </p>
            ...
            <div className="row no-gutters">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    To implement a persistent storage application using Express
                    JS. API call request of a random user or create a user API
                    and make it managable by means of CRUD operations and access
